...
class Produto (models.Model):
    ...
    preco = models.DecimalField(decimal_places=2, max_digits=4, default=0)
...
class Pedido(models.Model):
    ...
    pagamento_opcoes = [
        ...
        (pagamento_2x, 'Parcelamento em 2 vezes'),
        (pagamento_3x, 'Parcelamento em 3 vezes'),
        (pagamento_4x, 'Parcelamento em 4 vezes'),
        (pagamento_5x, 'Parcelamento em 5 vezes'),
    ]
